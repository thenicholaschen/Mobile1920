...
import com.github.thenicholaschen.meeting08_trackmymoviequality.R
import com.github.thenicholaschen.meeting08_trackmymoviequality.database.MovieDatabase
import com.github.thenicholaschen.meeting08_trackmymoviequality.databinding.FragmentMovieDetailsBinding
import com.github.thenicholaschen.meeting08_trackmymoviequality.moviedetails.MovieDetailsFragmentArgs
import com.github.thenicholaschen.meeting08_trackmymoviequality.moviedetails.MovieDetailsFragmentDirections
...
class MovieDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        movieDetailsViewModel.navigateToMovieTracker.observe(this, Observer {status ->
            when (status) {
                "clear" -> {
                    this.findNavController().navigate(MovieDetailsFragmentDirections.actionMovieDetailsFragmentToMovieTrackerFragment())
