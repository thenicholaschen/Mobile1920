...
import com.github.acailuv.meeting08_trackmymoviequality.movieupdate.MovieUpdateFragmentDirections
                ...
                when (status) {
                    "clear" -> {
                        this.findNavController().navigate(
                            MovieUpdateFragmentDirections.actionMovieUpdateFragmentToMovieTrackerFragment()
                        )
